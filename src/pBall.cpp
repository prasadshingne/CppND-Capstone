...
pBall::pBall(int x, int y, int width, int height, int red, int grn, int blu, int a, int xVelocity, int yVelocity) : 
    pMovers(x, y, width, height, red, grn, blu, a), _xVelocity(xVelocity), _yVelocity(yVelocity) {}
